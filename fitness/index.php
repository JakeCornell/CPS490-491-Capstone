			...
			<header id="fh5co-header-section">
				<div class="container">
					<div class="nav-header">
						...
						<h1 id="fh5co-logo"><a href="index.html">Git<span>Fit</span></a></h1>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-4 animate-box">
							...
							<p>We are three Computer Science students with a passion for fitness.  Our goal with this project is to provide our users the benefit of tons of useful information regarding fitness, as well as a one stop shop for all their equipment and supplement needs!</p>
						</div>
